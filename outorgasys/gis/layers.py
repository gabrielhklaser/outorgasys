...
CAMADAS: dict[str, Camada] = {
    c.chave: c for c in [
        ...
        Camada("drenagem_rs", "Rede de drenagem", "drenagem_rs.gpkg", "linha",
               "IBGE - Base Cartografica Continua 1:250.000 (2021) / ANA BHO 2017",
               "https://geoftp.ibge.gov.br/cartas_e_mapas/bases_cartograficas_continuas/bc250/",
               "Distancia euclidiana ao corpo hidrico mais proximo",
               obrigatoria=True,
               campos_rotulo=("nome", "NOME", "Name", "no_rio_pri", "no_rio",
                               "nu_bacia", "NOMECOMP", "nomerio")),

        Camada("massas_dagua_rs", "Massas e corpos d'agua", "massas_dagua_rs.gpkg", "poligono",
               "IBGE - Base Cartografica Continua 1:250.000 (2021)",
               "https://geoftp.ibge.gov.br/cartas_e_mapas/bases_cartograficas_continuas/bc250/",
               "Corpos d'agua no raio de 500 m",
               campos_rotulo=("nome", "NOME", "Name", "NOMECOMP", "tipo")),

        Camada("nascentes_rs", "Nascentes", "nascentes_rs.gpkg", "ponto",
               "IBGE - Base Cartografica Continua 1:250.000 (2021)",
               "https://geoftp.ibge.gov.br/cartas_e_mapas/bases_cartograficas_continuas/bc250/",
               "Nascentes no entorno (Mapa 3)",
               campos_rotulo=("nome", "NOME", "Name", "NOMECOMP")),

        Camada("rodovias_rs", "Rodovias", "rodovias_rs.gpkg", "linha",
               "IBGE - Base Cartografica Continua 1:250.000 (2021)",
               "https://geoftp.ibge.gov.br/cartas_e_mapas/bases_cartograficas_continuas/bc250/",
               "Vias de acesso e faixas de dominio (Mapa 1)",
               campos_rotulo=("nome", "NOME", "Name", "NOMECOMP", "codtrechor", "jurisdicao")),

        Camada("ferrovias_rs", "Ferrovias", "ferrovias_rs.gpkg", "linha",
               "IBGE - Base Cartografica Continua 1:250.000 (2021)",
               "https://geoftp.ibge.gov.br/cartas_e_mapas/bases_cartograficas_continuas/bc250/",
               "Contexto de entorno",
               campos_rotulo=("nome", "NOME", "Name", "NOMECOMP")),

        Camada("cursos_dagua_rs", "Cursos d'agua", "cursos_dagua_rs.gpkg", "linha",
               ...
               "Rotulagem do corpo hidrico de referencia (opcional)",
